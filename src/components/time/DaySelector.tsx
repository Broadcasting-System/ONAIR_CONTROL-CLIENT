      ...
      {days.map((day) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center justify-center w-[89px] h-[89px] rounded-[7px] transition-all",
              isActive
          ...
          >
            <span className="font-orbitron font-normal text-[40px] leading-[0] mt-3 whitespace-pre-wrap">
              {day}
            </span>
          </button>
        );
