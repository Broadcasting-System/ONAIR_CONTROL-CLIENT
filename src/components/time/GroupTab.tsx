      ...
      {groups.map((group) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center justify-center w-[298px] h-[100px] rounded-[7px] pb-[10px] pt-[15px] transition-all",
              isActive
          ...
          >
            <span className="font-orbitron font-normal text-[40px] leading-[0] tracking-wider mt-4">
              {group.name}
            </span>
          </button>
        );
